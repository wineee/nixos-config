{ stdenv, lib, fetchurl, meson, ninja, pkg-config, wayland, alsa-lib, gtkmm3, gtk-layer-shell, pulseaudio, wayfire, wf-config, cmake, wlroots
}:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ meson ninja pkg-config wayland wayfire cmake ];
  buildInputs = [
    alsa-lib gtkmm3 gtk-layer-shell pulseaudio wlroots
  ];
